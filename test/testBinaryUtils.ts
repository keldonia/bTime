...
describe("Binary Utils", () => {
  ...
  describe("#findBinaryPointerFromDate(), assumes 5 min interval", () => {
    const tests = [
      { args: [0, 0], expected: 0 },
      { args: [0, 5], expected: 1 },
      { args: [1, 0], expected: 12 },
    ...
    tests.forEach(test => {
      ...
      it(testName, () => {
        ...
        const binaryPointer: number = binaryStringUtil.findBinaryPointerFromDate(testDate);
  ...
  describe("#generateBinaryStringFromAppointment(), assumes 5 min interval", () => {
    const tests = [
      { args: [4, 12, 5, 5], expected: "" },
      { args: [0, 12, 0, 24], expected: "" },
      { args: [1, 0, 1, 24], expected: "" },
    ...
    tests.forEach(test => {
      ...
      it(testName, () => {
        const bString: string | false = binaryStringUtil.generateBinaryStringFromAppointment(testAppt);
